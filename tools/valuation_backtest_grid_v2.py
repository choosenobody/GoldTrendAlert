...
# - Rolling out-of-sample intercept (base) estimated each month using a trailing window
# - Gold: Stooq -> FRED -> Yahoo fallback
# - TIPS: FRED DFII10 (monthly mean)
# - CB YoY: from WGC_CSV_URL; roll=12 (fallback 6); monthly
# - Position rule: pos_t = clamp(score_val_t/20, -1, 1), where score_val maps ±VAL_GAP_PCT% -> ±20
